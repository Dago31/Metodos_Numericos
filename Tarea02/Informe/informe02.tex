...
\chapter{Resolución de sistema de ecuaciones lineales}
 ...
 \begin{enumerate}
 	\item   Una matriz de Hilbert $H = (hij )$ es una matriz cuyos elementos son de la forma:\\
 	\centering
 	...
 	\newpage
 	 ...
 	 \begin{enumerate}
 	    ...
 	    \item Mencione en una tabla, la cantidad de iteraciones y el tiempo de ejecución, que usaron cada uno
de los métodos para obtener la solución aproximada. Comente sus resultados.
 	  \end{enumerate}
...
Debido a que la presión y el área varan con la elevación, la fuerza total se obtiene al calcular
 \begin{equation}
 f=\rho g\int_{0}^{D} w(z)*(D-z) \cdot dz
\end{equation}
Donde (2) y (3) son la densidad del agua y la aceleración de gravedad, respectivamente. Por ultimo, D=60 que indica la elevación en metros.
\begin{equation}
 \rho=10^3[kg/m^3] 
\end{equation}
